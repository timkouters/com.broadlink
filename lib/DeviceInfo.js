...
var devType2Info = function( devID ) {
	...
	if(( devID >= 0x7530 ) && ( devID <= 0x7918 )) {
		...
		case 0x5f36: info.type = BroadlinkType.RM;       info.name = 'RM3 Mini D'; break;

		// RM4
		case 0x51da: info.type = BroadlinkType.RM4;      info.name = "Broadlink RM4 Mini"; break
		case 0x610e: info.type = BroadlinkType.RM4;      info.name = "Broadlink RM4 Mini";
		case 0x62bc: info.type = BroadlinkType.RM4;      info.name = "Broadlink RM4 Mini";
		case 0x653a: info.type = BroadlinkType.RM4;      info.name = "Broadlink RM4 Mini";
		case 0x6070: info.type = BroadlinkType.RM4;      info.name = "Broadlink RM4 Mini C";
		case 0x62be: info.type = BroadlinkType.RM4;      info.name = "Broadlink RM4 Mini C";
		case 0x610f: info.type = BroadlinkType.RM4;      info.name = "Broadlink RM4 Mini C";
		case 0x6539: info.type = BroadlinkType.RM4;      info.name = "Broadlink RM4 Mini C";
		case 0x648d: info.type = BroadlinkType.RM4;      info.name = "Broadlink RM4 Mini S";
		case 0x2225: info.type = BroadlinkType.RM4;      info.name = 'Manual RM4 Device';

		// RM4 Pro
		case 0x6026: info.type = BroadlinkType.RM4Pro;      info.name = "Broadlink RM4 Pro";
		case 0x61a2: info.type = BroadlinkType.RM4Pro;      info.name = "Broadlink RM4 Pro";
		case 0x649b: info.type = BroadlinkType.RM4Pro;      info.name = "Broadlink RM4 Pro";
		case 0x653c: info.type = BroadlinkType.RM4Pro;      info.name = "Broadlink RM4 Pro";
		case 0x2227: info.type = BroadlinkType.RM4Pro;      info.name = 'Manual RM4 Pro Device';
